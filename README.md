...
# Below figure shows the final PCB with soldered components, mounted on the STMicrocontroller.
![circuit](https://github.com/qahaidari/Embedded-Radar/blob/main/images/circuit.jpg)
